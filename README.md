...
- В шапке используется горизонтальная PNG-версия логотипа B2E, собранная из AI-концепта ChatGPT Image: ферма/балка, графит и желтый акцент.
- Все интерфейсные и производственные иконки заменены на адаптивные PNG 1x/2x/3x из сгенерированного ChatGPT Image листа; SVG-иконки в интерфейсе не используются.
