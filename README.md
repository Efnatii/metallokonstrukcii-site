...
- Карта в контактах переключает главный офис и производственные направления из ТЗ: Петрозаводск, Никольское, Рыбацкое. В ТЗ нет точных адресов производственных площадок, поэтому для них используются поисковые точки городов/районов в Яндекс Картах.
...
| `B2E_YANDEX_MAP_EMBED_URL` | URL iframe Яндекс Карты для главного офиса. Площадками управляет HTML-блок контактов. |
