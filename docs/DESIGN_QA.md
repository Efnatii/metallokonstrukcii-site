...
- Browser/public GitHub Variables: `B2E_SITE_URL`, `B2E_CONTACT_PHONE`, `B2E_CONTACT_PHONE_DISPLAY`, `B2E_WORK_HOURS`, `B2E_CONTACT_EMAIL`, `B2E_MAX_URL`, `B2E_ADDRESS`, `B2E_YANDEX_MAP_URL`, `B2E_YANDEX_MAP_EMBED_URL`, `B2E_RBC_PROFILE_URL`, `B2E_RUSPROFILE_URL`, `B2E_CATALOG_URL`, `B2E_LEAD_ENDPOINT`, `B2E_STATS_ENDPOINT`, `YANDEX_SITE_BUCKET`, `YANDEX_STATS_BUCKET`, `YANDEX_FUNCTION_NAME`, `YANDEX_GATEWAY_NAME`, `YANDEX_CUSTOM_DOMAIN`, `YANDEX_CERTIFICATE_ID`.
- Private GitHub Secrets: `YC_SERVICE_ACCOUNT_KEY_JSON`, `YC_CLOUD_ID`, `YC_FOLDER_ID`, `SMTP_HOST`, `SMTP_PORT`, `SMTP_SECURE`, `SMTP_USERNAME`, `SMTP_PASSWORD`, `SMTP_FROM`, `SMTP_FROM_NAME`, `SMTP_ENVELOPE_FROM`, `SMTP_TO`, `LEAD_WEBHOOK_URL`, `TELEGRAM_BOT_TOKEN`, `TELEGRAM_CHAT_ID`, `SMARTCAPTCHA_SERVER_KEY`.
- `B2E_LEAD_ENDPOINT` is public and normally stays `/api/leads` behind Yandex API Gateway.
